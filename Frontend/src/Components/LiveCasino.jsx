        ...
        {data?.map((casino, index) => (
          ...
          >
            ...
            <div className="flex md:hidden">
              <div className="relative w-1/2 bg-pink-900 p-3 flex flex-col items-center justify-center gap-2">
                <div className="relative rounded border-2 border-yellow-400 max-w-auto h-28 flex items-center justify-center">
                  <img
                    src={casino?.image}
                    alt={casino?.name}
                    ...
                    />
                    {casino.topPosition && (
                    <div className="absolute bg-yellow-500 w-7 h-6 -top-0.5 -left-0.5 text-white text-center rounded-br-sm rounded-tl-sm">{casino.topPosition}</div>
                    )}
                </div>
            ...
            <div className="hidden md:flex lg:hidden p-4">
              <div className="flex w-full">
                <div className="w-2/5 flex flex-col items-center pr-4">
                  <div className="relative rounded border-2 border-yellow-400 w-full max-w-[180px] h-[180px] flex items-center justify-center mb-3">
                    <img
                      src={casino?.image}
                      alt={casino?.name}
                      className="object-cover h-full w-full"
                    />
                    {casino.topPosition && (
                    <div className="absolute bg-yellow-500 w-7 h-6 top-0 left-0 text-white text-center rounded-br-sm">{casino.topPosition}</div>
                    )}
                  </div>
            ...
            <div className="hidden lg:flex lg:flex-row lg:w-auto lg:h-40">
              {casino.topPosition && (
              <div className="absolute bg-purple-700 w-7 h-6 text-white text-center rounded-br-sm rounded-tl-sm">{casino.topPosition}</div>
              )}
