...
const Reviews = () => {
  ...
  const detectTagType = (tagText) => {
    const negativeKeywords = ["scam", "fraud", "rude", "not pay", "bad", "avoid"];
    const positiveKeywords = ["excellent", "great", "friendly", "fast", "good", "reliable"];
    const lowercaseTag = tagText.toLowerCase();
    return negativeKeywords.some((word) => lowercaseTag.includes(word))
      ? "negative"
      : positiveKeywords.some((word) => lowercaseTag.includes(word))
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <button
              onClick={toggleModal}
              className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-blue-600 transition-all duration-300 shadow-md"
            >
              Write a Review
            </button>
          </div>
